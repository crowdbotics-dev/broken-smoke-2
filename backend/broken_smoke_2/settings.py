"""
Django settings for broken_smoke_2 project.
...
ROOT_URLCONF = 'broken_smoke_2.urls'
...
WSGI_APPLICATION = 'broken_smoke_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_smoke_2 API",
    "DESCRIPTION": "API documentation for broken_smoke_2 App",
    "VERSION": "v1",
}
